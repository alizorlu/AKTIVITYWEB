...
import {
    ...
    , Drawer, Progress, Statistic, Tooltip, Comment,Rate
} from 'antd'
...
function callback(key) {
 ...
 class Activity_Content_Partial extends Component {
    state = {
                            ...
                            <Row type="flex">
                                ...
                                <Col span={24}>
                                    ...
                                    <TabPane tab={
                                            <div>
                                                <Icon type="message" />
                                                <Text>Hakkındaki yorumlar ve değerlendirmeler</Text>
                                            </div>
                                        } key="2">
                                        <div>
                                                <Comment
                                                    ...
                                                    datetime={
                                                        <div>
                                                            ...
                                                            <Divider type="vertical"/>
                                                            <Text>Samimiyet </Text>
                                                                <Rate allowHalf value={3.5} style={{fontSize:15}} /> 
                                                            <Divider type="vertical"/>
                                                            <Text>Güleryüzlü</Text>
                                                                <Rate allowHalf style={{fontSize:15}} /> 
                                                            <Divider type="vertical"/>
                                                            </div>
                                                    }
...
export default Activity_Content_Partial;